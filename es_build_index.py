...
def set_mapping():
    ...
    # 创建Index和mapping
    create_index = elastic.indices.create(index='hourseserch', body=my_mapping)  # {u'acknowledged': True}
...
if __name__ == '__main__':
    logging.basicConfig(level=logging.WARNING,
                        format='%(asctime)s %(temmoliufilename)s[line:%(lineno)d] %(levelname)s %(message)s',
